/*
 * 1. Definición del array con los cursos destacados que se mostrarán en la página.
 * 2. Renderizado dinámico de las tarjetas dentro del contenedor de cursos.
 * 3. Creación de elementos HTML para cada curso y asignación de sus propiedades.
 *
